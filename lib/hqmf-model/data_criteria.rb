module HQMF
  ...
  class DataCriteria
    ...
    def initialize(id, title, description, standard_category, qds_data_type, code_list_id, children_criteria, property,type, 
    ...
    def self.from_json(id, json)
      ...
      HQMF::DataCriteria.new(id, title, description, standard_category, qds_data_type, code_list_id, children_criteria,
