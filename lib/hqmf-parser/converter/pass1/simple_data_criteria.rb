  ...
  module Converter
    ...
    class SimpleDataCriteria < HQMF::DataCriteria
      ...
      def self.from_data_criteria(data_criteria)
        ...
        data_criteria.code_list_id, data_criteria.children_criteria, data_criteria.derivation_operator, data_criteria.property,data_criteria.type,data_criteria.status, data_criteria.value, data_criteria.field_values, data_criteria.effective_time,
        data_criteria.inline_code_list,data_criteria.negation,data_criteria.negation_code_list_id,data_criteria.temporal_references, data_criteria.subset_operators)
      end
