  ...
  module Converter
    ...
    class SimpleDataCriteria < HQMF::DataCriteria
      ...
      def self.from_data_criteria(data_criteria)
        ...
        data_criteria.code_list_id, data_criteria.children_criteria, data_criteria.property,data_criteria.type,data_criteria.status, data_criteria.value, data_criteria.effective_time,
